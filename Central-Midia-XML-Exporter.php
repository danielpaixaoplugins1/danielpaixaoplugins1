<?php
/*
  Plugin Name: Central Midia XML Exporter
  Description: Central Midia XML Exporter was built to export a large number of custom post type posts from one website to another.
  Version: 1.2
...
$cmx3export = new CentralMidiaXMLExporter(); // Nome da classe correspondente ao nome do arquivo

class CentralMidiaXMLExporter { // Nome da classe correspondente ao nome do arquivo
    ...
    function create_menus() {
        ...
        add_management_page(
            __("Central Midia XML Exporter"), __("Central Midia XML Exporter"), "export", "cmx3export", array($this, "admin_page")
        );
    }
        ...
        <div class="wrap">
            ...
            <form method="get" id="export-filters" action="tools.php">
                <fieldset>
                    ...
                    <input type="hidden" name="page" value="cmx3export" />
                    <input type="hidden" name="cmx3export" value="true" />
    ...
    function cpt_export_add_attachments($post_ids) {
        $attachments = array();
    ...
    function export_wp() {
        ...
        if ('all' != $args['content']):
            $post_ids = $this->cpt_export_add_attachments($post_ids);
        endif;
